...
export const PROJECTS: Project[] = [
  {
    ...
    overviewVideoUrl: "https://youtu.be/z2edJ8OYDyU",
...
- 민감도 분석 1위: char_base_atk(캐릭터 기초 ATK) — DPS 전반 영향도 최상위`
  },
  {
    ...
    tags: ["코어루프", "무기교체", "맵프리팹", "절차적생성"],
    image: "./images/digreed.png",
    gallery: Array.from({ length: 14 }, (_, i) => `./images/digreed_ebook/page_${(i + 1).toString().padStart(3, '0')}.png`),
    scenarioGallery: Array.from({ length: 16 }, (_, i) => `./images/digreed_scenario/슬라이드${i + 1}.PNG`),
    pdfUrl: "./documents/digreed_mvp_plan.pdf",
    documentLabel: "MVP 기획서",
    ganttUrl: "https://oil-cod-c15.notion.site/c94787e73bfd830685b281006c76e658",
    overviewVideoUrl: "https://youtu.be/DkuijnqOcU0",
...
- 탈출 조건: 아이템 3개 수집 + 탈출문 상호작용`
  },
  {
    ...
    documentLabel: "시스템 기획서",
    overviewVideoUrl: "https://www.youtube.com/embed/5vjTeHe0Ozs",
    ganttUrl: "https://oil-cod-c15.notion.site/2a1787e73bfd807f8405db59f6d07aac",
...
- 전 수치를 목표 게임타임 3~5분/판 기준으로 역산 설계`
  },
  {
    ...
    tags: ["바이브코딩", "유니티", "핵심루프", "빠른검증"],
    image: "./images/picobang.png",
    overviewVideoUrl: "https://www.youtube.com/watch?v=G6x1KBO-_uU",
