...
export const PROJECTS: Project[] = [
  {
    ...
    title: "도로시아",
    roles: ["밸런스 기획"],
    description: "핵앤슬래시 방치형 RPG의 PDPS 기반 전투 밸런스와 성장 구조를 총괄 설계했습니다.",
    keyTasks: ["피해 공식 설계", "경험치 테이블 구축", "재화 흐름 밸런싱"],
    tags: ["전투 공식 설계", "성장 곡선 설계", "경험치 테이블"],
...
- 오프라인 방치 보상 밸런싱 최적화`
  },
  {
    ...
    title: "Digreed",
    roles: ["시스템 기획", "콘텐츠 기획"],
    description: "잠입 액션 로그라이트 게임의 전체 룰 및 시스템을 설계했습니다.",
    keyTasks: ["코어 루프 설계", "무기 교체 시스템", "맵 프리팹 기획"],
    tags: ["코어 룰 설계", "시스템 기획", "시스템 문서화"],
...
- 절차적 생성의 한계를 보완하는 수동 프리팹 블록화 기획`
  },
  {
    ...
    title: "침묵의 저택",
    roles: ["시스템 기획"],
    description: "메이플월드 플랫폼 생존 공포 게임의 추격 시스템을 설계했습니다.",
    keyTasks: ["추격자 AI 패턴", "시야 축소 메카닉", "상호작용 규칙"],
    tags: ["AI 행동 패턴 설계", "메카닉 기획", "시스템 설계"],
...
- 공간 내 숨기, 아이템 획득 및 탈출 로직 기획`
  },
  {
    ...
    keyTasks: ["아이디어 검증", "핵심 루프 구현", "플레이 테스트"],
    tags: ["프로토타이핑", "바이브코딩", "신속한 아이디어 검증"],
...
- 수치 조정 및 피드백을 통한 빠른 밸런싱 능력`
  },
  {
    ...
    title: "게임 스토어의 불청객",
    roles: ["AI 활용", "문서화"],
    description: "LLM 기반의 비정형적이고 자유로운 시나리오 챗봇 시스템을 기획했습니다.",
    keyTasks: ["LLM 프롬프트 설계", "가변 시나리오 구조", "단서 추출 로직"],
    tags: ["AI 프롬프트 엔지니어링", "시나리오 기획", "시스템 설계"],
