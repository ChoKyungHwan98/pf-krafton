...
export const RESUME_DATA: ResumeData = {
  ...
  selfIntroductions: [
    ...
    },
    {
      ...
      body: "매 시험마다 **핵심 주장을 한 문장으로 정한 뒤**, 모든 항목이 그것을 관통하는지 반복해서 검증했습니다. 주장이 흔들리면 목차 전체가 무너졌고, 목차가 무너지면 답안 전체가 설득력을 잃었습니다. **7년 동안 이 실패를 반복하며** 구조를 다듬었습니다.\n\n그 훈련의 성과는 **졸업 논문**이었습니다. 다른 학생들이 자료를 먼저 뒤지고 본문부터 채워나갈 때, 저는 **목차를 먼저 완성**했습니다.\n\n탄탄한 목차가 완성된 뒤 본문 작성은 그 내용을 채우는 일에 불과했고, 그 결과 누구보다 빠르게 논문을 완성했습니다. 결과는 **95점**이었습니다.",
      closing: "**설득력 있는 주장은 논리가 아니라, 그 논리를 담는 구조에서 나옵니다.** 기획 의도를 알고 목차를 작성하는 능력은, 7년간의 실패가 만들어준 저의 역량입니다."
    },
    {
      navTitle: "AI 활용 능력",
