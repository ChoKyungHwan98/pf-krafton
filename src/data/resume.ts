  ...
  selfIntroductions: [
    {
      ...
      body: "그 자리에서 확신했습니다. 법학이 −에서 0으로 되돌리는 일이라면, 게임은 0에서 +가 되는 경험을 만든다는 것을. 저도 누군가의 하루를 움직이는 사람이 되고 싶었습니다.",
      closing: "법학을 공부하며 배운 것이 있습니다. 모든 제도는 입법 **'의도'**를 바탕으로 **'구조화'**되며, 사회라는 하나의 **'시스템'**으로 작동한다는 것입니다. 저는 이 원리가 **게임 기획의 본질**과 같다고 믿습니다.\n\n저는 그 **+를 설계하는 기획자**가 되겠습니다."
    },
    {
      navTitle: "핵심 역량",
