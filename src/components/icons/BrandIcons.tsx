...
export const BRAND_ICONS: Record<string, React.ReactNode> = {
  ...
  Figma: (
    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none">
  ...
  Unity: (
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-black">
  ...
  Gemini: (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65" className="w-full h-full">
